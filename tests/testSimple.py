...
class TestSimple(CPSTestCase):
    ...
    def testCss(self):
        ...
        # Testing the CSS page generated by CPSSkins with the theme config
        view_id = 'renderCSS'
        method = getattr(self.portal.portal_themes.default, view_id)
        rendering = method()
        self.assertValidCss(rendering, view_id)
    ...
    def testAdminSkinsAtSectionsAndWorkspaces(self):
        ...
        for folder_id in ('sections', 'workspaces', 'members'):
            ...
            for view_id in view_ids:
                ...
                self.assertValidXHTML(rendering, ressource_name)
                # Testing the CSS pages referenced from a web page along with
                # the inlined CSS property contained in the web page itself.
                self.assertValidCss(rendering, ressource_name)
