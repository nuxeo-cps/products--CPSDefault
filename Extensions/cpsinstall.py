...
"""
    ...
    def setupPortlets(self):
        ...
        portlets = {
            'top_tabs': {'type': 'Navigation Portlet',
                'slot': 'toptabs',
                'display': 'navigation_tree',
                'Title': 'Navigation',
               },
            'breadcrumbs': {'type': 'Breadcrumbs Portlet',
                'slot': 'top',
            ...
            'object_actions': {'type': 'Actions Portlet',
                'slot': 'right',
                'order': 0,
                'categories': ['object', 'workflow'],
                'Title': 'Object actions',
                },
            'address': {'type': 'Text Portlet',
                'slot': 'bottom',
                'Title': 'Address',
                'text': '<address>Nuxeo - 18-20, rue Soleillet, 75020 Paris France<br />Email : <a href="mailto:contact@nuxeo.com">contact@nuxeo.com</a> - Tel: +33 (0)1 40 33 79 87 - Fax: +33 (0)1 40 33 71 41</address>',
                'text_format': 'normal',
                'text_position': 'html',
                'order': 0,
                },
            'conformance_statement': {'type': 'Custom Portlet',
                'slot': 'bottom',
                'custom_cache_params': [],
                'order': 10,
            ...
            'language_selector': {'type': 'Language Portlet',
                'slot': 'left',
                'action': 'change',
                'Title': 'Language selector',
                },
            'navigation': {'type': 'Navigation Portlet',
                'slot': 'left',
                'order': 50,
                'display': 'navigation_tree',
                'show_icons': 1,
